...
summary: "Guía general de DoCatFlow v25.0: 10 módulos principales (CatBrains, CatPaws, Skills, CatFlow, Templates, Conectores, Canvas comerciales, CatBot, Configuración, Estado), equipo comercial, arquitectura técnica y convenciones importantes."
tags: [ux, learning]
...
change_log:
  - { version: 1.0.0, date: 2026-04-20, author: catbot:phase-151, change: "Migrated verbatim from .planning/knowledge/user-guide.md during Phase 151 (frontmatter added, body preserved)" }
ttl: managed
---
