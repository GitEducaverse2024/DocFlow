...
summary: "Skill maestra de CatBot: logica de decision para reutilizar/crear CatPaws, estructurar canvas, vincular conectores. 14 PARTES cubriendo arquitectura, decision, creacion, canvas-building, catalogos, interaccion, ejemplos, errores, data contracts, tool-calling avanzado, diagnostico."
...
change_log:
  - { version: 2.0.0, date: 2026-04-20, author: catbot:phase-151, change: "Migrated verbatim from repo root to KB protocols/; 14 PARTES preserved. H1 'SKILL: ...' replaced by '# Orquestador Inteligente DoCatFlow' (skill/version metadata now lives in frontmatter). DESCRIPCION + all 14 PARTES kept byte-identical." }
ttl: never
---

# Orquestador Inteligente DoCatFlow
