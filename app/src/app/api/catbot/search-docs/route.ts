...
// Phase 155: `.planning/knowledge/` removed; canonical knowledge lives in
// `.docflow-kb/` accessed via `search_kb` + `get_kb_entry`. This route remains
// as a fallback for top-level planning docs (PROJECT/STATE/ROADMAP/Index) and
// progress sessions.
const DOC_PATHS = [
  // Planning docs
