...
- [ ] Retry con backoff exponencial: max 3 intentos, delays 1s/2s/4s para 5xx y timeouts
- [ ] Delay mínimo 150ms entre requests
- [ ] Logger de requests/responses (truncar a 500 chars, omitir API key)
